...
const char html_page_unit[] PROGMEM =
    ...
    "<b>MHI Frame Size</b>"
    "<select name='frame'>"
    "<option value='0' _FRAME_SHORT_>Short (20 bytes)</option>"
    "<option value='1' _FRAME_LONG_>Long (33 bytes)</option>"
    "</select>"
    "</p>"
    "<p>"
    "<b>Energy Monitoring</b>"
    "<select name='energy_mode'>"
    "<option value='0' _ENERGY_INTERNAL_>Internal (AC meter)</option>"
    "<option value='1' _ENERGY_CALC_FIXED_>Calculated (fixed voltage)</option>"
    "<option value='2' _ENERGY_CALC_MQTT_>Calculated (voltage from MQTT)</option>"
    "</select>"
    "</p>"
    "<p><b>Voltage (V)</b> for calculated mode"
    "<br/>"
